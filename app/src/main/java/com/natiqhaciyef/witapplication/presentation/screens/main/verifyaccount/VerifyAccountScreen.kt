...
fun VerifyAccountScreen(
    ...
    verifyViewModel: VerifyAccountViewModel = hiltViewModel()
) {
    val userState = remember { verifyViewModel.userState }
    ...
    Column(
        ...
        if (userState.value.data != null) {
            InputBoxTitle(
                concept = "Full Name",
                input = remember { mutableStateOf(userState.value.data!!.name) },
                isEnabled = false,
                isSingleLine = true,
            ...
            InputBoxTitle(
                concept = "Email",
                input = remember { mutableStateOf(userState.value.data?.email ?: "") },
                isEnabled = false,
                isSingleLine = true,
                isBottomShadowActive = false
            )
        ...
        Button(
            ...
            onClick = {
                if (password.value == userState.value.data?.password) {
                    ...
                    verifyViewModel.insertVerifiedUser(
                        verifiedUserModel,
